        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-start md:justify-between gap-6">
          <div className="flex-1">
            <nav className="flex items-center gap-2 text-xs mb-5" style={{ color: "#4b5563" }}>
              ...
              <span>/</span>
              <span style={{ color: "#60a5fa" }}>Administración</span>
            </nav>
            ...
            <div className="flex items-center gap-3 mb-3">
              ...
              <span className="text-xs font-bold uppercase tracking-widest" style={{ color: "#60a5fa" }}>Panel de Administración</span>
            </div>
          ...
          <div className="flex gap-3 shrink-0 self-start md:self-center">
            <Link
              href="/admin/reportes"
              className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 px-5 py-2.5 text-sm font-bold text-white shadow-xl shadow-blue-500/10 hover:scale-[1.02] active:scale-95 transition-all duration-200 cursor-pointer animate-fade-in"
            >
