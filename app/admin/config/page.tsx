      ...
      <div className="relative overflow-hidden rounded-3xl p-8 sm:p-10 mb-8 anim-fade-up"
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-start md:justify-between gap-6">
          ...
          <div className="flex gap-3 shrink-0 self-start md:self-center">
            <Link
              href="/admin/reportes"
              className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-violet-500 to-indigo-500 hover:from-violet-600 hover:to-indigo-600 px-5 py-2.5 text-sm font-bold text-white shadow-xl shadow-violet-500/10 hover:scale-[1.02] active:scale-95 transition-all duration-200 cursor-pointer animate-fade-in"
            >
